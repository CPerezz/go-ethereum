...
// unexpected panics.
func repairHistory(db ethdb.Database, isPBT bool, readOnly bool, stateID uint64, enableTrienode bool) (ethdb.ResettableAncientStore, ethdb.ResettableAncientStore, error) {
	...
	states, err := rawdb.NewStateFreezer(ancient, isPBT, readOnly)
	if err != nil {
	...
	if enableTrienode {
		trienodes, err = rawdb.NewTrienodeFreezer(ancient, isPBT, readOnly)
		if err != nil {
